...
export default function ContactPage() {
    ...
    const contactMethods = [
        ...
        {
            title: 'Address',
            value: '123 High Street, Edinburgh, EH1 1AA',
            icon: '📍',
                    ...
                    <ScrollAnimation animationType="scale">
                        <div className="max-w-2xl mx-auto text-center bg-white rounded-3xl shadow-2xl p-12">
                            ...
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Thank you for contacting Fegors. We've received your message and will get back to you
                                within 24 hours.
                            </p>
                            <Link
                                href="/"
                    ...
                    <ScrollAnimation animationType="fade-up">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-lg md:text-xl text-white/90 leading-relaxed">
                                Have a question about our services or want to discuss your cleaning needs?
                ...
                <div className="container-custom mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {contactMethods.map((method, index) => (
                            <ScrollAnimation key={method.title} animationType="fade-up" delay={index * 100}>
                                <a
                                    href={method.link}
                            ...
                            <ScrollAnimation animationType="slide-right">
                                <div className="bg-white rounded-3xl shadow-xl p-8 mb-8">
                                    ...
                                    <p className="text-sm text-gray-500 mt-6">
                                        Don't see your area? <Link href="/quote" className="text-eco-green font-semibold hover:underline">Contact us</Link> to check availability.
                                    </p>
                                </div>
                                ...
                                <ScrollAnimation animationType="fade-up" delay={100}>
                                    <div className="bg-gradient-to-br from-eco-green to-eco-green-hover rounded-3xl shadow-xl p-8 text-white">
                                        ...
                                        <p className="text-white/90 mb-6">
                                            Get a detailed, personalized quote for your cleaning needs in 24 hours.
                                        </p>
                                        <Link
                                            href="/quote"
                ...
                <div className="container-custom mx-auto px-6">
                    <ScrollAnimation animationType="fade-up">
                        <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-soft-grey/40 to-white rounded-3xl p-12 border-2 border-eco-green/10">
                            ...
                            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                Whether you need residential, commercial, or specialist cleaning services,
                                we're here to deliver exceptional results.
                            </p>
