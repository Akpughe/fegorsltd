...
export default function StoryHero() {
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-deep-navy via-deep-navy-light to-deep-navy">
            ...
            <div className="relative z-10 container-custom mx-auto px-6 text-center">
                ...
                <div className="inline-flex items-center gap-2 bg-eco-green/20 border border-eco-green/30 backdrop-blur-sm rounded-full px-6 py-2 mb-8 animate-fade-in">
                    ...
                    <span className="text-white font-medium">Scotland's First 100% Water-Based Cleaning</span>
                </div>
                ...
                <p className="text-white/90 text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-200">
                    ...
                    Just pure water, advanced technology, and a commitment to your health and our planet.
                </p>

                {/* CTA Buttons */}
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animation-delay-300">
                    <Button href="/quote" variant="cta" className="text-lg px-8 py-4 !bg-eco-green !text-white hover:!bg-eco-green-hover transform hover:scale-105 transition-transform">
                        Start Your Story →
                    </Button>
