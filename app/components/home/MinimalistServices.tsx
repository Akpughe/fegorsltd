    ...
    const services = [
        {
            ...
            description: 'Keep your home spotless and healthy with regular maintenance or deep cleans. Perfect for busy families who want a safe, chemical-free environment.',
            features: ['Weekly/Fortnightly Service', 'Deep Spring Cleaning', 'Move In/Out Cleaning', 'Post-Event Cleanup'],
            image: 'https://images.unsplash.com/photo-1556911220-bff31c812dba?w=600&q=80',
            href: '/services/residential'
        },
        {
            title: 'Commercial Cleaning',
            description: 'Create productive, healthy workspaces that impress clients and inspire teams. From small offices to large retail spaces.',
            features: ['Daily Office Cleaning', 'Retail Floor Care', 'Reception & Common Areas', 'Washroom Sanitization'],
            image: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=600&q=80',
            href: '/services/commercial'
        },
        {
            title: 'Eco Water-Based Cleaning',
            description: 'Experience the future of cleaning. Our revolutionary Tennant technology uses pure ionized water to achieve 99.9% bacteria removal.',
            features: ['Zero Harsh Chemicals', 'Instant Dry Time', 'Hospital-Grade Clean', 'Safe for All Surfaces'],
            image: 'https://images.unsplash.com/photo-1563453392212-326f5e854473?w=600&q=80',
            href: '/services/eco-cleaning'
        },
        {
            title: 'Specialist Deep Cleaning',
            description: 'Intensive cleaning for demanding situations. Floor treatments, post-construction cleanup, and comprehensive sanitization projects.',
            features: ['Floor Polishing & Sealing', 'Post-Construction', 'Grout & Tile Restoration', 'Carpet Deep Clean'],
        ...
        <section className="py-32 bg-white">
            <div className="container-custom mx-auto px-6">
                ...
                <div className="max-w-3xl mb-20">
                    <span className="text-eco-green font-bold text-sm uppercase tracking-wider mb-4 block">Our Services</span>
                    <h2 className="text-5xl md:text-6xl font-black text-brand-black mb-6 leading-tight">
                        Cleaning solutions for every space
                    </h2>
                    <p className="text-xl text-gray-600">
                        From homes to offices, we deliver exceptional results using the safest, most sustainable methods available.
                    </p>
                </div>
                            ...
                            >
                                ...
                                <div className={`relative ${!isEven ? 'lg:col-start-2' : ''}`}>
                                    ...
                                    <div className="absolute -bottom-4 -right-4 bg-eco-green text-white rounded-2xl px-6 py-3 shadow-xl">
                                        <div className="text-sm font-semibold">From £{(index + 1) * 25}/visit</div>
                                    </div>
                                </div>
                ...
                <div className="mt-20 bg-soft-grey rounded-3xl p-12 text-center">
                    ...
                    <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                        We&apos;ll help you find the perfect cleaning solution for your space and budget.
                    </p>
