        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-32 items-center">
          <div className="lg:col-span-7 order-2 lg:order-1">
            <div className="relative">
              ...
              <span className="text-red-500 font-bold text-sm uppercase tracking-wider mb-4 block">
                The Problem
              </span>
              ...
              <div className="space-y-4 text-lg text-gray-700">
                <div className="flex items-start gap-4 p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
                  ...
                  <div>
                    <strong>Harsh chemicals</strong> leave toxic residues that
                    harm your family, pets, and staff
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
                  <svg
                  ...
                  <div>
                    <strong>Poor indoor air quality</strong> from chemical fumes
                    causes headaches and respiratory issues
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
                  <svg
                  ...
                  <div>
                    <strong>Environmental damage</strong> as chemicals wash into
          ...
          <div className="lg:col-span-7">
            <div className="relative">
              ...
              <p className="text-xl text-gray-700 mb-8 leading-relaxed">
                Our revolutionary water-based cleaning system uses advanced
                ionization to clean at the molecular level - delivering
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-linear-to-r from-eco-green/10 to-transparent rounded-lg border-l-4 border-eco-green">
                  ...
                  <div>
                    ...
                    Perfect for families with children, pets, and people with
                    sensitivities
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-linear-to-r from-eco-green/10 to-transparent rounded-lg border-l-4 border-eco-green">
                  ...
                  <div>
                    ...
                    Removes 99.9% of bacteria without a single harsh chemical
                  </div>
                </div>
              </div>
            </div>
