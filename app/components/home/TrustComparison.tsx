        ...
        <section className="py-20 bg-white">
            <div className="container-custom mx-auto px-6">
                ...
                <div className="max-w-3xl mb-16">
                    <span className="text-eco-green font-bold text-sm uppercase tracking-wider mb-4 block">Why Choose Water-Based?</span>
                    <h2 className="text-5xl font-black text-brand-black mb-6 leading-tight">
                        See the difference for yourself
                    </h2>
                    <p className="text-xl text-gray-600">
                        An honest comparison between traditional chemical cleaning and our revolutionary water-based approach.
                    </p>
                </div>
                ...
                <div className="mt-12 text-center">
                    <p className="text-gray-600 mb-4">Ready to experience the Fegors difference?</p>
                    <a
                        href="/quote"
