  ...
  const steps = [
    {
      ...
      description:
        "Our advanced equipment ionizes pure water, creating powerful cleaning molecules that break down dirt at a molecular level.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "The ionized water penetrates surfaces deeper than traditional chemicals, lifting embedded dirt, bacteria, and contaminants.",
      icon: (
        <svg
          className="w-full h-full"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Removes 99.9% of bacteria and pathogens without leaving any chemical residue - just pure, clean surfaces.",
      icon: (
        <svg
          className="w-full h-full"
          fill="none"
    ...
    },
    {
      ...
      description:
        "No waiting for chemicals to dry or fumes to clear. Your space is ready to use instantly, safe for everyone.",
      icon: (
        <svg
          className="w-full h-full"
          fill="none"
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-brand-black mb-6 leading-tight">
            ...
            <span className="block text-eco-green">
              cleans better than chemicals
            </span>
          </h2>
          <p className="text-xl text-gray-700 leading-relaxed">
            It sounds too good to be true, but it&apos;s science. Our advanced
            water-based technology revolutionizes cleaning with four simple
            steps.
          </p>
        </div>
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative group">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-eco-green/20 h-full">
                  ...
                  {/* Icon */}
                  <div
                    className={`w-16 h-16 ${step.color} rounded-xl flex items-center justify-center text-white mb-6 transform group-hover:scale-110 transition-transform`}>
                    {step.icon}
                  </div>
