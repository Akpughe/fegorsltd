    ...
    const services = [
        {
            ...
            description: 'Transform your home into a sanctuary. From weekly maintenance to deep cleans, we keep your space spotless and safe.',
        ...
        },
        {
            ...
            description: 'First impressions matter. Create healthy, productive environments that wow clients and inspire teams.',
        ...
        },
        {
            ...
            description: 'Experience the future of cleaning. Advanced Tennant equipment. Zero chemicals. 100% results.',
        ...
        },
        {
            ...
            description: 'Intensive floor treatments, post-construction cleanup, and comprehensive sanitization projects.',
    ...
    return (
        <section className="py-20 bg-soft-grey">
            <div className="container-custom mx-auto px-6">
                {/* Section Header */}
                <div className="mb-16">
                    <span className="text-eco-green font-bold text-sm uppercase tracking-wider mb-4 block">What We Do</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {services.map((service, index) => {
                        ...
                        return (
                            ...
                            >
                                {/* Background Gradient */}
                                <div className={`absolute inset-0 bg-gradient-to-br ${service.color} opacity-90 group-hover:opacity-100 transition-opacity`}></div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div>
                            ...
                            <p className="text-gray-600">
                                Let&apos;s chat! We&apos;ll help you find the perfect cleaning solution.
                            </p>
                        </div>
                        <Link
                            href="/contact"
