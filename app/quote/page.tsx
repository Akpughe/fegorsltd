          ...
          <ScrollAnimation animationType="scale">
            <div className="max-w-2xl mx-auto text-center bg-white rounded-3xl shadow-2xl p-12">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                We&apos;ve received your quote request and our team will review
                it shortly. You can expect to hear from us within 24 hours with
          ...
          <ScrollAnimation animationType="fade-up">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 leading-relaxed">
                ...
                detailed, personalized quote within 24 hours. No obligation,
                completely free.
              </p>
            </div>
          </ScrollAnimation>
