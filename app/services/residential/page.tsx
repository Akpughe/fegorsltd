  ...
  const services = [
    {
      ...
      description:
        "Regular scheduled cleaning to keep your home consistently fresh and tidy.",
      icon: "📅",
    },
    {
      title: "Deep cleaning",
      description:
        "Intensive top-to-bottom cleaning for a thorough refresh of your entire home.",
      icon: "✨",
    },
    {
      title: "End-of-tenancy",
      description:
        "Professional cleaning to ensure you get your deposit back when moving out.",
      icon: "🔑",
    },
    {
      title: "Move-in/move-out",
      description: "Preparing your new home or cleaning up after you leave.",
      icon: "📦",
    },
    {
      title: "Student flats & HMOs",
      description:
        "Specialized cleaning for student accommodation and shared housing.",
      icon: "🎓",
    },
    {
      title: "Post-renovation cleaning",
      description:
        "Removing dust and debris after building work or home improvements.",
      icon: "🔨",
    },
  ];
  ...
  const process = [
    {
      ...
      description:
        "Choose your cleaning type and schedule a convenient time through our simple booking system.",
    },
    {
      step: "02",
      title: "We Prepare",
      description:
        "Our team reviews your requirements and arrives with all necessary eco-friendly supplies and equipment.",
    },
    {
      step: "03",
      title: "Expert Cleaning",
      description:
        "Our trained professionals clean your home thoroughly following our comprehensive checklist.",
    },
    {
      step: "04",
      title: "Final Inspection",
      description:
        "We conduct a quality check and address any concerns to ensure you're completely satisfied.",
    },
  ];
          ...
          <div className="container-custom mx-auto px-6">
            <div className="max-w-2xl">
              ...
              <p className="text-lg md:text-xl text-white/90 leading-relaxed mb-8 animate-fade-in-up animation-delay-100">
                Whether you need regular cleaning or a full deep clean, we help
                keep your home fresh, healthy, and comfortable.
              </p>
              <Link
                href="/quote"
          ...
          <ScrollAnimation animationType="fade-up">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Ideal for: families, shared flats, landlords, property managers.
              </p>
            </div>
          </ScrollAnimation>
          ...
          <ScrollAnimation animationType="fade-up">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8 leading-relaxed">
                Request a free quote today and discover the difference
                professional residential cleaning can make.
              </p>
