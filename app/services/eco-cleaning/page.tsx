    ...
    const features = [
        {
            ...
            description: 'Our Tennant T300 machine uses only water to clean and sanitize, eliminating the need for harsh chemicals entirely.',
            icon: '🚫'
        },
        {
            title: 'Safe for Everyone',
            description: 'Perfect for homes with children, pets, or individuals with chemical sensitivities and allergies.',
            icon: '👨‍👩‍👧‍👦'
        },
        {
            title: 'Environmentally Friendly',
            description: 'Zero chemical runoff means zero environmental impact. Clean your space while protecting the planet.',
            icon: '🌍'
        }
    ];
    ...
    const process = [
        {
            step: '01',
            title: 'Consultation',
            description: 'We assess your space and discuss how our eco-cleaning technology can meet your specific needs.'
        },
        {
            step: '02',
            title: 'Preparation',
            description: 'Our team arrives with the Tennant T300 and prepares the area for chemical-free cleaning.'
        },
        {
            step: '03',
            title: 'Eco Cleaning',
            description: 'Using advanced water-based technology, we deep clean and sanitize every surface effectively.'
        },
        {
            step: '04',
            title: 'Quality Check',
            description: 'We inspect the results and ensure you\'re satisfied with our environmentally conscious service.'
        }
    ];
                    ...
                    <div className="container-custom mx-auto px-6">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-lg md:text-xl text-white/95 leading-relaxed mb-8 animate-fade-in-up animation-delay-100">
                                Experience the power of chemical-free cleaning with our advanced Tennant T300 technology.
                                Effective, safe, and 100% environmentally friendly.
                            </p>
                            <Link
                                href="/quote"
                ...
                <div className="container-custom mx-auto px-6">
                    <ScrollAnimation animationType="fade-up">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Our water-based cleaning technology represents a revolutionary approach to maintaining clean,
                                healthy spaces without compromising your health or the environment.
                            </p>
                        </div>
                    </ScrollAnimation>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {features.map((feature, index) => (
                            <ScrollAnimation key={feature.title} animationType="fade-up" delay={index * 100}>
                        ...
                        <ScrollAnimation animationType="slide-right">
                            <div>
                                ...
                                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                    The Tennant T300 is an industry-leading cleaning machine that uses innovative ec-H2O
                                    technology to convert water into a powerful cleaning solution — without any chemicals.
                                </p>
                                <p className="text-gray-600 mb-8 leading-relaxed">
                                    This revolutionary technology electrically converts water into an activated solution that
                                    cleans effectively, dries quickly, and leaves no chemical residue. It's proven to eliminate
                                    99.9% of bacteria while being completely safe for humans, pets, and the environment.
                                </p>
                        ...
                        <ScrollAnimation animationType="slide-left">
                            <div>
                                ...
                                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                    Choose eco-cleaning for a healthier home, office, or facility that's free from toxic
                                    chemicals and harmful fumes.
                                </p>
                ...
                <div className="container-custom mx-auto px-6">
                    <ScrollAnimation animationType="fade-up">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Our eco-cleaning process is simple, effective, and designed to give you peace of mind.
                            </p>
                        </div>
                    </ScrollAnimation>
                    ...
                    <ScrollAnimation animationType="fade-up">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-lg md:text-xl text-white/95 mb-8 leading-relaxed">
                                Join hundreds of satisfied clients who've made the smart choice for their health and the environment.
                                Get a free quote for chemical-free cleaning today.
                            </p>
