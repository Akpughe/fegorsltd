    ...
    const services = [
        {
            ...
            description: 'Professional floor cleaning, polishing, and restoration for all floor types including hardwood, tile, vinyl, and carpet.',
            icon: '🏢',
            features: ['Deep cleaning', 'Polishing & sealing', 'Stain removal', 'Restoration']
        },
        {
            title: 'Post-Construction',
            description: 'Comprehensive cleanup after construction or renovation projects, removing dust, debris, and residue.',
            icon: '🏗️',
            features: ['Dust removal', 'Paint & debris cleanup', 'Window cleaning', 'Final touch-ups']
        },
        {
            title: 'Sanitisation Services',
            description: 'Advanced sanitisation and disinfection services using hospital-grade products for maximum protection.',
            icon: '🦠',
            features: ['Deep sanitisation', 'Disinfection', 'Anti-viral treatment', 'Odor elimination']
        },
        {
            title: 'Custom Solutions',
            description: 'Tailored cleaning solutions for unique challenges including industrial cleaning, high-reach areas, and special projects.',
            icon: '⚡',
            features: ['Industrial cleaning', 'High-reach access', 'Special materials', 'Emergency services']
        }
    ];
    ...
    const process = [
        {
            step: '01',
            title: 'Assessment',
            description: 'We evaluate your unique cleaning challenge and determine the best approach and equipment needed.'
        },
        {
            step: '02',
            title: 'Custom Plan',
            description: 'We create a detailed action plan with timeline, methods, and safety protocols specific to your project.'
        },
        {
            step: '03',
            title: 'Expert Execution',
            description: 'Our specialist team executes the plan using advanced equipment and proven techniques.'
        },
        {
            step: '04',
            title: 'Verification',
            description: 'We conduct thorough quality checks and ensure all objectives are met to your satisfaction.'
        }
    ];
                    ...
                    <div className="container-custom mx-auto px-6">
                        <div className="max-w-2xl">
                            ...
                            <p className="text-lg md:text-xl text-white/90 leading-relaxed mb-8 animate-fade-in-up animation-delay-100">
                                From floor restoration to post-construction cleanup, our specialist services tackle the toughest
                                cleaning challenges with precision and expertise.
                            </p>
                            <Link
                                href="/quote"
                    ...
                    <ScrollAnimation animationType="fade-up">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Our specialist cleaning team has the training, equipment, and expertise to handle unique
                                cleaning challenges that require advanced solutions.
                            </p>
                        </div>
                    </ScrollAnimation>
                                    ...
                                    <ul className="grid grid-cols-2 gap-2">
                                        {service.features.map((feature) => (
                                            <li key={feature} className="flex items-center text-sm text-gray-600">
                                                <svg className="w-4 h-4 text-sky-blue mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <ScrollAnimation animationType="slide-right">
                            <div>
                                ...
                                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                                    When standard cleaning isn't enough, our specialist team brings advanced skills and
                                    equipment to solve your most challenging cleaning needs.
                                </p>
                ...
                <div className="container-custom mx-auto px-6">
                    <ScrollAnimation animationType="fade-up">
                        <div className="text-center max-w-3xl mx-auto mb-12">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Our specialist cleaning services are perfect for these situations and more:
                            </p>
                        </div>
                    </ScrollAnimation>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            { title: 'Renovation Cleanup', description: 'Post-construction dust and debris removal', icon: '🔨' },
                            { title: 'Floor Restoration', description: 'Restore shine and protect all floor types', icon: '✨' },
                            { title: 'Deep Sanitisation', description: 'Hospital-grade disinfection and sanitisation', icon: '🧪' },
                            { title: 'Emergency Cleanup', description: 'Rapid response for urgent cleaning needs', icon: '🚨' },
                            { title: 'Industrial Spaces', description: 'Heavy-duty cleaning for manufacturing areas', icon: '🏭' },
                            { title: 'High-Reach Areas', description: 'Specialized equipment for difficult access', icon: '🪜' }
                        ].map((useCase, index) => (
                            <ScrollAnimation key={useCase.title} animationType="scale" delay={index * 50}>
                ...
                <div className="container-custom mx-auto px-6">
                    <ScrollAnimation animationType="fade-up">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Every specialist project follows a rigorous process to ensure outstanding results.
                            </p>
                        </div>
                    </ScrollAnimation>
                    ...
                    <ScrollAnimation animationType="fade-up">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="text-lg md:text-xl text-white/90 mb-8 leading-relaxed">
                                Our specialist team is ready to assess your unique situation and provide expert solutions.
