  ...
  const services = [
    {
      ...
      description:
        "Consistent cleaning schedules to keep your workspace professional and productive.",
      icon: "📅",
    },
    {
      title: "Workstation cleaning",
      description:
        "Detailed cleaning of desks, monitors, and equipment to ensure hygiene.",
      icon: "💻",
    },
    {
      title: "Breakroom & kitchen cleaning",
      description:
        "Maintaining sanitary conditions in communal eating and food preparation areas.",
      icon: "☕",
    },
    {
      title: "Washroom hygiene",
      description: "Thorough cleaning and sanitization of restroom facilities.",
      icon: "🚿",
    },
    {
      title: "Meeting room cleaning",
      description:
        "Preparing conference spaces for your next important meeting.",
      icon: "🤝",
    },
    {
      title: "Rubbish management",
      description: "Regular waste collection and recycling management.",
      icon: "♻️",
    },
    {
      title: "Floor care",
      description: "Vacuuming, mopping, and maintenance for all floor types.",
      icon: "🧹",
    },
  ];
  ...
  const process = [
    {
      ...
      description:
        "We visit your facility to understand your specific needs, traffic patterns, and cleaning requirements.",
    },
    {
      step: "02",
      title: "Custom Plan",
      description:
        "We create a tailored cleaning schedule and checklist that fits your business operations and budget.",
    },
    {
      step: "03",
      title: "Professional Service",
      description:
        "Our experienced team executes the cleaning plan with precision, using commercial-grade equipment.",
    },
    {
      step: "04",
      title: "Quality Assurance",
      description:
        "Regular inspections and feedback loops ensure consistent results and continuous improvement.",
    },
  ];
          ...
          <div className="container-custom mx-auto px-6">
            <div className="max-w-2xl">
              ...
              <p className="text-lg md:text-xl text-white/90 leading-relaxed mb-8 animate-fade-in-up animation-delay-100">
                We provide reliable, flexible cleaning for offices, tech spaces,
                co-working hubs, retail, and more. Including everyday commercial
                cleaning for clients like Skyscanner Edinburgh.
              </p>
              <Link
                href="/quote"
          ...
          <ScrollAnimation animationType="fade-up">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Ideal for: offices, tech hubs, retail, co-working spaces.
              </p>
            </div>
          </ScrollAnimation>
        ...
        <div className="container-custom mx-auto px-6">
          <ScrollAnimation animationType="fade-up">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Our commercial cleaning expertise spans across multiple
                industries with specialized knowledge for each sector.
              </p>
            </div>
          </ScrollAnimation>
            ...
            <ScrollAnimation animationType="slide-left">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  We understand that a clean workspace is essential for
                  productivity, employee morale, and making the right impression
        ...
        <div className="container-custom mx-auto px-6">
          <ScrollAnimation animationType="fade-up">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                A proven approach to commercial cleaning that delivers
                consistent, reliable results for your business.
              </p>
            </div>
          </ScrollAnimation>
          ...
          <ScrollAnimation animationType="fade-up">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8 leading-relaxed">
                Partner with Fegors for reliable commercial cleaning that
                enhances your business environment and leaves a lasting
                impression.
              </p>
